...
public class CoreFixtures {
    private static final Instant INSTANT = Instant.parse("2024-11-09T06:11:56Z");
    ...
    public static final Clock CLOCK_AFTER_TOKEN_EXPIRATION = Clock.offset(CLOCK, Duration.ofHours(12));
}