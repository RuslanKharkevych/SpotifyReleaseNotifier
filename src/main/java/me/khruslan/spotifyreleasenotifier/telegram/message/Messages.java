...
public class Messages {
    ...
    public static final String STATUS_LOGGED_IN = """
            🎉 You’re all set!
            
            You will receive Telegram notifications when new music is released \u2060📣""";

    public static final String STATUS_LOGGED_OUT = """
            👤 You haven't logged in yet!

            Please enter /login and follow instructions to get started \u2060🎶
            """;
